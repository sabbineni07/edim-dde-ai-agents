...
SELECT
  ...
  CAST(total_worker_gb_provisioned AS DOUBLE) AS total_worker_gb_provisioned,
...
class DatabricksCollector:
    ...
    def list_job_runs(
        ...
        SELECT
          ...
          COALESCE(MAX(total_worker_gb_provisioned), 0.0) AS total_worker_gb_provisioned,
    ...
    def get_job_metrics(
        ...
        SELECT
          ...
          COALESCE(AVG(total_worker_gb_provisioned), 0.0) AS avg_total_worker_gb_provisioned,
