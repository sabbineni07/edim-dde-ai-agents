"""FastAPI middleware: bind per-request Databricks user OAuth tokens for SQL collectors."""
...
class DatabricksUserTokenMiddleware(BaseHTTPMiddleware):
    """Store forwarded user OAuth token in a context var for the request lifetime."""
