...
class TokenUsageTracker:
    ...
    def add_usage(self, chain_name: str, model: str, input_tokens: int, output_tokens: int):
    ...
    def estimate_chain_usage(self, chain_name: str, model: str, input_text: str, output_text: str):
